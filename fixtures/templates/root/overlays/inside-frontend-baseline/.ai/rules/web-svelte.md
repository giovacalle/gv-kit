...
| API response DTO (Hono/Hey API generated) | `packages/openapi-client/` — don't redeclare in the app |
...
└── routes/
    ...
    ├── +layout.server.ts       # session loader (whichever auth state the app needs)
